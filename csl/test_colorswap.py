#!/usr/bin/env python3
"""
Host test script for WSE-2 color-swap inject+flow LWW coloring prototype.

Test graph: 4-vertex path  V0 -- V1 -- V2 -- V3
Partition:  PE0={V0}, PE1={V1}, PE2={V2}, PE3={V3}
Cross-PE edges: (V0,V1), (V1,V2), (V2,V3)

With color swap, every broadcast reaches ALL PEs (not just 1-hop neighbors).
Expected: valid coloring with no adjacent conflicts.

Usage:
  cs_python test_colorswap.py  (from csl_colorswap_out/)
  OR: /home/siddharthb/tools/cs_python test_colorswap.py
"""
import os
import sys
import numpy as np
