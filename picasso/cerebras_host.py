#!/usr/bin/env python3
"""
Cerebras host script (v2) — runs inside cs_python (singularity container).

Design changes (v2):
  Fix 1: Hash-based GID partitioning (power-of-2 PE count, bitwise AND).
  Fix 2: Widened dest_pe (11 bits in wavelet encoding).
  Fix 3: Sentinel-based barrier (no dedicated barrier colors).
  Fix 4: No software relay — hardware pass-through routing.
  Fix 5: Dynamic termination — sentinels replace static expected_total_recv.
