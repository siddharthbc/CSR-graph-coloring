...
def run_cerebras_benchmark(vertex_counts, num_pes, grid_rows, edge_prob):
    """
    ...
    repo_root = script_dir  # benchmark_crossover.py is at repo root
    ...
    compiled_dir = os.path.join(repo_root, 'csl_compiled_out')
